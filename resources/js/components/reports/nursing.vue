    ...
    let self = this;
     axios.get('/api/pkrc/')
      ...
      showModal() {
       ...
       toggleModal(id) {
         axios.get('/api/nursingreports/'+id)
       ...
       register(){
          axios.post('/api/nursingreports', this.form)
          .then(() => {
        window.location.reload()
      ...
      patientUpdate(){
       ...
       axios.patch('/api/nursingreports/'+id, this.forms)
       .then(() => {    
         let self = this;
        axios.get('/api/nursingreports/')
       .then(function (response) {
       ...
       .catch(error =>this.errors = error.response.data.errors)
         ...
         viewModal(record) {
          let self = this;
            axios.get('/api/nursingreports/'+record.id)
  	     .then(function (response) {
